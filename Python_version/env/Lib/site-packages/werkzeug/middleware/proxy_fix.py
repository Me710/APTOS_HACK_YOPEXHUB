...
``X-Forwarded-`` headers that proxies in templates of an application may
set.
...
that are chained in templates of it. Not all proxies set all the headers.
...
class ProxyFix:
    ...
    templates of the application may set.
